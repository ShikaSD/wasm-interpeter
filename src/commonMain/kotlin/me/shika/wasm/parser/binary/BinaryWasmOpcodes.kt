...
internal object BinaryWasmOpcodes {
    ...
    const val StructNew = 0x00
    const val StructNewDefault = 0x01
    const val StructGet = 0x02
    const val StructGetS = 0x03
    const val StructGetU = 0x04
    const val StructSet = 0x05
    const val ArrayNew = 0x06
    const val ArrayNewDefault = 0x07
    const val ArrayNewFixed = 0x08
    const val ArrayNewData = 0x09
    const val ArrayNewElem = 0x0A
    const val ArrayGet = 0x0B
    const val ArrayGetS = 0x0C
    const val ArrayGetU = 0x0D
    const val ArraySet = 0x0E
    const val ArrayLen = 0x0F
    const val ArrayFill = 0x10
    const val ArrayCopy = 0x11
    const val ArrayInitData = 0x12
    const val ArrayInitElem = 0x13
    const val RefTestNotNull = 0x14
    const val RefTest = 0x15
    const val RefCastNotNull = 0x16
    const val RefCast = 0x17
    const val AnyConvert = 0x1A
    const val ExternConvert = 0x1B

    // DataOp (0xFC_XX)
    const val DataOp = 0xFC
    const val i32_trunc_sat_f32_s = 0x00
    const val i32_trunc_sat_f32_u = 0x01
    const val i32_trunc_sat_f64_s = 0x02
    const val i32_trunc_sat_f64_u = 0x03
    const val i64_trunc_sat_f32_s = 0x04
    const val i64_trunc_sat_f32_u = 0x05
    const val i64_trunc_sat_f64_s = 0x06
    const val i64_trunc_sat_f64_u = 0x07
    const val MemoryInit = 0x08
    const val DataDrop = 0x09
    const val MemoryCopy = 0x0A
    const val MemoryFill = 0x0B
    const val TableInit = 0x0C
    const val ElemDrop = 0x0D
    const val TableCopy = 0x0E
    const val TableGrow = 0x0F
    const val TableSize = 0x10
    const val TableFill = 0x11
